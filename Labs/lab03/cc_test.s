...
inc_arr_loop:
    ...
    sw t0, 4(sp)       # Save t0 before calling function.
    sw t1, 8(sp)       # Save t1 before calling function.
    jal helper_fn
    # Finished call for helper_fn
    lw ra, 0(sp)       # Restore return address.
    lw t0, 4(sp)       # Restore t0 before calling function.
    lw t1, 8(sp)       # Restore t1 before calling function.
    addi sp, sp, 12    # Adjust stack to delete 2 items.
